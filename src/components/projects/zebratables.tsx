  ...
  return (
    <>
      <div>
        <h3>Status</h3>
        <p>
          Playable MVP, with a few completed puzzles to solve. I'm currently exploring an "Arcade Mode" concept, as well
          as improving the tutorial experience. Go ahead and try it out!
        </p>
      </div>
      <div>
        <h3>Inspiration</h3>
      ...
      <div>
        ...
        <ScBodySideBySide>
          <div>
            ...
            <br />
            <p>
              My process for creating puzzles typically involves coming up with objects that compare and constrast in
              many different ways. For example: For football, basketball, and tennis - football and basketball use a
              *leather* ball, while basketball and tennis have a *round* ball.
            </p>
            <br />
            <p>
              ...
              played - ideally this was for my benefit, so that I wouldn't have to come up with all the custom puzzles
              and prompts. As development continued, I found that auto-generating puzzles was in direct conflict with
              making the clues fun, creative, and challenging - and I spent more time messign with the puzzle generation
              code than making the actual game!. Perhaps someday I'll revisit automatic puzzle generation with AI - but
              for now I enjoy explicitly creating the puzzles myself
            </p>
          </div>
          <div>
            <Codeblock>{`{
